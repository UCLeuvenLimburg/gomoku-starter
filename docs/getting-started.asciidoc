...
----
var value = 1;
var doubleOfX = value * 2; // doubleOfX == 2
value = 5;                 // doubleOfX == 10
value = 2;                 // doubleOfX == 4
value = 7;                 // doubleOfX == 14
----

Unfortunately, Reactive Programming is not built into C#.
This is where Cells come in: these can be used to "fake" Reactive Programming.

[source,csharp]
----
var x = ICell.Create(1);
var doubleOfX = x.Derive(x => x * 2); // doubleOfX.Value == 2
